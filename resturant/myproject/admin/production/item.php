					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method='post' action="functions/addItem.php" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">item name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="itemName" id="first-name" required="required" class="form-control ">
											</div>
										</div>
							

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">item image <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="file" name="itemImg" id="first-name"  class="form-control ">
											</div>
										</div>

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">item price <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="number" name="itemPrice" id="first-name" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea name="itemDes" id="first-name" required="required" class="form-control "> </textarea>
											</div>
										</div>
										...
										<div class="item form-group" >
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">item catagory<span class="required">*</span>
											</label>
											<div class="radio">
													<label style="display: block;">
														<input name="radio" type="radio" checked="" value="drinks" id="optionsRadios1" name="optionsRadios"> Drink
													</label>
													<label style="display: block;">
														<input name="radio" type="radio" value="lunch" id="optionsRadios2" name="optionsRadios"> lunch
													</label>
													<label style="display: block;">
														
														<input name="radio" type="radio" value="dinner" id="optionsRadios3" name="optionsRadios"> Dinner
													</label>
