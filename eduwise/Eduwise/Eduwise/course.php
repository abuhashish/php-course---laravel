...
require_once("admin/production/functions/getAllCourse.php");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="admin/production/images/<?php echo $course['courseImage']; ?>" alt="" class="img-fluid" style="height:212px;"></a></div>
                        <div class="purchase_price">
                            <a href="#" class="read_more-btn">$ <?php echo $course['coursePrice'];?></a>
                        </div>
                    </div>
                    <div class="courses_info_wrapper">
                        <div class="courses_title">
                            <h3><a href="course-details.php?courseId="> <?php echo $course['courseName'];?>  </a></h3>
                            <div class="teachers_name">Teacher - <a href="#" title="">Jhonthan Smith</a></div>
                        </div>
                        <div class="courses_info">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-user"></i><?php  echo $course['courseDays'];?> Days</li>
                                <li><i class="fas fa-calendar-alt"></i><?= $course['courseCapacity']; ?> Students</li>
                            </ul>
