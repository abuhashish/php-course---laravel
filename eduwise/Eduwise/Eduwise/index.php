                    ...
                    <div class="info_wrapper">
                        ...
                        <div class="login_info">
                             ...
                             ?>
                                ...
                                <li class="nav-item"><a href="#" class="nav-link join_now js-modal-show"><i class="flaticon-padlock"></i>Log out</a></li>
                                <?php } ?>
                    ...
                    <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                        ...
                        <div class="tab-content card">
                            ...
                            <div class="tab-pane fade" id="panel2" role="tabpanel">
                                <form action="admin/production/functions/addUser.php" method='post' enctype="multipart/form-data" class="register">
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name='phoneNumber' class="form-control" placeholder="Password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name='dob' class="form-control" placeholder="Password">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
